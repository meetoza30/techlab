...
function JoinUS() {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center innercontain my-auto">
      <h1 className="font-bold mb-4 text-black text-5xl headstate">Join Our <span className="bg-black px-3 py-1 text-orange-400 text-5xl font-bold amaz">Amazing Community</span></h1>
      ...
      <div className="bg-white p-8 iconbox rounded-lg shadow-md text-center items-center justify-center text-wrap">
        ...
        >
          ...
          <div className="flex items-center justify-center">
            <svg className="w-5 h-5 mr-2 whatslogo font-extrabold" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 21 16">
            ...
            <span className="font-bold">Join WhatsApp Community</span>
          </div>
        </button>
      </div>
    </div>
    ...
    <div className="flex flex-col justify-center items-center socials">
        ...
        <div className="mt-10 mb-10 socialbtns">
