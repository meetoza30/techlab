...
function Home(){
    ...
    <h1 className="text-5xl text-black font-bold text-wrap text-center">Empowering students to <span className="text-red-600">code their future</span>,<span className="text-red-600"> master AI</span>, and <span className="text-red-600">shape tomorrow's tech culture</span>.</h1>
