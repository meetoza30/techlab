    ...
    return(
        ...
        <footer className="flex flex-row justify-around items-center bg-orange-600  h-10 text-center">
            ...
            <Link to="https://www.instagram.com/techlabcommunity/" className="text-white iconboxhover:text-gray-200 left-0 mx-3" target='_blank'>
                        ...
                        <Link to="https://x.com/TechLabSocials" className="text-white icon  hover:text-gray-200 mx-3" target='_blank'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter-x icon" viewBox="0 0 16 16">
  <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z"/>
</svg>
                            <span className="sr-only">Twitter page</span>
                        </Link>

                        <Link to="https://www.linkedin.com/company/techlabsocials" className="text-white icon hover:text-gray-200 mx-3">
                            <svg
                        ...
                        <Link to="https://whatsapp.com/channel/0029Vaf2vXN3GJOzuZoq9J3G" className="text-white icon hover:text-gray-200 mx-3">
